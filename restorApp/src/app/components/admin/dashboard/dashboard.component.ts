    ...
    const mockOrders: Order[] = [
      {
        ...
        items: [
          { id: 1, order_id: 1, product_id: 1, quantity: 2, price: 12.50, product: { id: 1, name: 'Pizza Margarita', price: 12.50, stock: 10, is_active: true } },
          { id: 2, order_id: 1, product_id: 2, quantity: 1, price: 20.50, product: { id: 2, name: 'Pasta Carbonara', price: 20.50, stock: 5, is_active: true } }
        ]
      },
      {
        id: 2,
        ...
        items: [
          { id: 3, order_id: 2, product_id: 3, quantity: 1, price: 32.00, product: { id: 3, name: 'Hamburguesa Especial', price: 32.00, stock: 8, is_active: true } }
        ]
      },
      {
        id: 3,
        ...
        items: [
          { id: 4, order_id: 3, product_id: 1, quantity: 3, price: 12.50, product: { id: 1, name: 'Pizza Margarita', price: 12.50, stock: 10, is_active: true } },
          { id: 5, order_id: 3, product_id: 4, quantity: 2, price: 21.45, product: { id: 4, name: 'Ensalada César', price: 21.45, stock: 15, is_active: true } }
        ]
      }
    ];
